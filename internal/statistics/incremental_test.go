...
func TestIncrementalDescriptiveStatisticsShouldCorrectlyCalculateDescriptiveStatistics(t *testing.T) {
	...
	for _, c := range cases {
		stats := NewIncrementalDescriptiveStatistics(c.MovingMeanResolution)
